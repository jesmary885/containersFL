{{--
    ...
    Un solo formulario. Se quitó el segundo paso que preguntaba a qué
    empresa entrar: ahora entra a su empresa predeterminada y la cambia,
    si hace falta, desde el selector de arriba del menú.

    El diseño no cambió en nada más.
--}}
<div class="min-h-screen flex bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
    ...
    <div class="hidden lg:flex w-1/2 relative items-center justify-center px-28 overflow-hidden bg-slate-950">

        <!-- Imagen de fondo -->
        <img src="{{ Storage::url('logo/IMAGEN_LOGIN.png') }}"
             alt=""
    ...
    <div class="flex w-full lg:w-1/2 items-center justify-center bg-slate-200 px-6 lg:px-10">
        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.18)] px-10 py-10">
            ...
            <form wire:submit.prevent="entrar" class="space-y-7">
                ...
                <button
                    ...
                    wire:target="entrar"
                    class="w-full bg-slate-900 text-white py-3 rounded-lg font-semibold tracking-wide hover:bg-blue-800 disabled:opacity-60 transition-all duration-300 shadow-lg hover:shadow-blue-900/30"
                >
                    <span wire:loading.remove wire:target="entrar">Acceder</span>
