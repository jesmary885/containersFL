        ...
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu">
                ...
                {{--
                    ...
                    Se quitó del menú, y no por olvido.

                    La tabla `sales` existe con 30 columnas y NADIE escribe
                    en ella. El flujo que sí funciona es otro:

                        Presupuesto  →  convertToInvoice()  →  Factura

                    O sea que la factura ES la venta. Mientras el menú
                    ofrecía "Ventas", ofrecía una pantalla en construcción
                    para algo que ya está resuelto en Facturación, y hacía
                    creer que faltaba un paso del ciclo.

                    La ruta `comercial.ventas.index` se deja viva a
                    propósito: si en la reunión se decide que sí hace falta
                    un documento intermedio, vuelve con descomentar una
                    entrada. Borrarla obligaría a rehacerla.
                --}}
                @canany(['customers.view', 'estimates.view'])
